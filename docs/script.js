...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log(`
    🚀 Welcome to SiteSeeker!

    SiteSeeker is your intelligent browser history and bookmark search companion for macOS.

    Features:
    - Lightning-fast search through Chrome and Firefox history
    - Smart bookmark search with 'b:' prefix
    - Beautiful native macOS interface
    - Global shortcut: ⌘+⇧+Space
    - Privacy-first: All data stays on your computer

    Download: https://github.com/hakancelikdev/SiteSeeker/releases
    GitHub: https://github.com/hakancelikdev/SiteSeeker

    Made with ❤️ by Hakan Çelik
    `);
});
